    ...
    <div class="row">
                        ...
                        <div class="card mb-3 d-flex flex-row">
                            ...
                            <div class="col-md-10 px-3 d-flex align-items-center">
                                <div class="d-flex flex-column">
                                    <h5 class="fw-semibold"><a href="/productdetails/{{ $p->slug }}" class="text-decoration-none text-dark">{{ $p->product_name }}</a></h5>
        ...
        <div class="col-4 p-0">
            <div class="bg-white h-auto pb-2 sticky-top">
                ...
                <div class="my-3 px-3">
                    <h4 class="card-title"><a href="/productdetails/{{ $product->slug }}" class="text-decoration-none text-dark">{{ $product->product_name }}</a></h4>
